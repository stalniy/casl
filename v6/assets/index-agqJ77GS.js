...
`;function Xt(){return"v6"}async function ur(){return(await ue("/versions.txt",{format:"txtArrayJSON",cache:!0})).body}function dr(t){return window.location.href.replace(`/${Xt()}/`,`/${t}/`)}function _o(t){window.location.href=dr(t.target.value)}class Qt extends F{constructor(){super(),this._versions=[],this._currentVersion=Xt(),this._currentVersion&&this._versions.push({number:this._currentVersion})}async connectedCallback(){super.connectedCallback();const e=await ur();this._versions=e.slice(0).reverse(),this.requestUpdate()}render(){return y`
      <select @change=${_o}>
...
//# sourceMappingURL=index-agqJ77GS.js.map
