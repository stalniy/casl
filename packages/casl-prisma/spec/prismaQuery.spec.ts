...
describe('PrismaQuery evaluation', () => {
  ...
  describe('not', () => {
    it('throws when comparing with object without nested operators or array', () => {
      expect(() => prismaQuery({ items: { not: {} } })).toThrow(/does not supports comparison of arrays and objects/)
      expect(() => prismaQuery({ items: { not: Object.create(null) } })).toThrow(/does not supports comparison of arrays and objects/)
      expect(() => prismaQuery({ items: { not: [] } })).toThrow(/does not supports comparison of arrays and objects/)
    })
  ...
  describe('notIn', () => {
    it('throws if passed value is not an array', () => {
      expect(() => prismaQuery({ items: { notIn: {} } })).toThrow(/expects to receive an array/);
    })
  ...
  describe('lt, lte', () => {
    it('throws if value is not comparable (string, number or Date)', () => {
      expect(() => prismaQuery({ name: { lt: true } })).toThrow(/expects to receive comparable value/)
      expect(() => prismaQuery({ name: { lte: [] } })).toThrow(/expects to receive comparable value/)
      expect(() => prismaQuery({ name: { lte: NaN } })).toThrow(/expects to receive comparable value/)
      expect(() => prismaQuery({ name: { lt: Infinity } })).toThrow(/expects to receive comparable value/)
    })
  ...
  describe('gt, gte', () => {
    it('throws if value is not comparable (string, number or Date)', () => {
      expect(() => prismaQuery({ name: { gt: true } })).toThrow(/expects to receive comparable value/)
      expect(() => prismaQuery({ name: { gte: [] } })).toThrow(/expects to receive comparable value/)
      expect(() => prismaQuery({ name: { gte: NaN } })).toThrow(/expects to receive comparable value/)
      expect(() => prismaQuery({ name: { gt: Infinity } })).toThrow(/expects to receive comparable value/)
    })
  ...
  describe('startsWith', () => {
    it('throws if value is not a string', () => {
      expect(() => prismaQuery({ name: { startsWith: 1 } })).toThrow(/expects to receive string/);
      expect(() => prismaQuery({ name: { startsWith: {} } })).toThrow(/expects to receive string/);
    })
  ...
  describe('endsWith', () => {
    it('throws if value is not a string', () => {
      expect(() => prismaQuery({ name: { endsWith: 1 } })).toThrow(/expects to receive string/);
      expect(() => prismaQuery({ name: { endsWith: {} } })).toThrow(/expects to receive string/);
    })
  ...
  describe('hasSome', () => {
    it('throws if value is not an array', () => {
      expect(() => prismaQuery({ items: { hasSome: 1 } })).toThrow(/expects to receive an array/);
      expect(() => prismaQuery({ items: { hasSome: {} } })).toThrow(/expects to receive an array/);
    })
  ...
  describe('hasEvery', () => {
    it('throws if value is not an array', () => {
      expect(() => prismaQuery({ items: { hasEvery: 1 } })).toThrow(/expects to receive an array/);
      expect(() => prismaQuery({ items: { hasEvery: {} } })).toThrow(/expects to receive an array/);
    })
  ...
  describe('AND', () => {
    it('throws if value is not an object or array', () => {
      expect(() => prismaQuery({ AND: 1 })).toThrow(/expects to receive an array or object/);
      expect(() => prismaQuery({ AND: 'test' })).toThrow(/expects to receive an array or object/);
    })
  ...
  describe('OR', () => {
    it('throws if value is not an object or array', () => {
      expect(() => prismaQuery({ OR: 1 })).toThrow(/expects to receive an array or object/);
      expect(() => prismaQuery({ OR: 'test' })).toThrow(/expects to receive an array or object/);
    })
  ...
  describe('NOT', () => {
    it('throws if value is not an object or array', () => {
      expect(() => prismaQuery({ NOT: 1 })).toThrow(/expects to receive an array or object/);
      expect(() => prismaQuery({ NOT: 'test' })).toThrow(/expects to receive an array or object/);
    })
