          ...
          <div class="col row wrap align-start main">
            ...
            <div class="col details">
              ...
              <div class="buttons">
                ...
                <a href="${Et.repoURL}" target="_blank" rel="noopener" class="btn btn-lg">
                  ${G(`buttons.source`)}
                </a>
                <github-button
                  size="large"
...
`;function pa(){return`v7`}async function ma(){return(await L(`/versions.txt`,{format:`txtArrayJSON`,cache:!0})).body}function ha(e){return window.location.href.replace(`/${pa()}/`,`/${e}/`)}function ga(e){window.location.href=ha(e.target.value)}var _a=class extends M{constructor(){super(),this._versions=[],this._currentVersion=pa(),this._currentVersion&&this._versions.push({number:this._currentVersion})}async connectedCallback(){super.connectedCallback();let e=await ma();this._versions=e.slice(0).reverse(),this.requestUpdate()}render(){return A`
      <select @change=${ga}>
...
//# sourceMappingURL=index-BmI3HAMr.js.map